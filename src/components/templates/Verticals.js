          ...
          <div className="ski-container--960">
            <section className="ski-container--960 ski-terms--simple">
              ...
              <p>
                ...
                on purchases on eBay.co.uk in selected categories, unless
              ...
              <p>
                ...
                or more on eBay.co.uk in one of the following eligible
                categories:
              </p>

              <ol>
                {props.categories.split(";").map((o, i) => (
                  <li key={i}>
                    <span className={addEditable("categorieslist")}>{o}</span>
                  </li>
                ))}
              </ol>
