...
export default class MultiSeller extends Component {
  render() {
          ...
          <div className="ski-container--960">
            <section className="ski-container--960 ski-terms--simple">
              ...
              <p>
                ...
                on purchases on eBay.co.uk from selected sellers, unless
              ...
              <p>
                ...
                or more on eBay.co.uk from one of the following eligible
                sellers:
              </p>

              <ol>
                {props.sellers.split(";").map((o, i) => (
                  <li key={i}>
                    <span className={addEditable("sellerslist")}>
                      <a href={`${o.split(",")[1]}`} target="_blank">
                        {o.split(",")[0]}
                      </a>
                    </span>
                  </li>
